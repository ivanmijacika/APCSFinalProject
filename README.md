...
This is the production (development) branch of our project, where we add new features before merging to the main branch.
For the full README with the UML diagram & development log, see the main branch.